...
# Nome do Bucket
NOME_BUCKET = "iac-emr-machine-learning-bucket"
...
# Grava o log
dsa_grava_log("Log - Bucket Encontrado.", bucket)

# Grava o log
dsa_grava_log("Log - Inicializando o Apache Spark.", bucket)
...
try:
	...
	dsa_grava_log("Log - Ocorreu uma falha na Inicialização do Spark", bucket)
	dsa_grava_log(traceback.format_exc(), bucket)
	raise Exception(traceback.format_exc())

# Grava o log
dsa_grava_log("Log - Spark Inicializado.", bucket)
...
try:
	...
	dsa_grava_log("Log - Ocorreu uma falha na limpeza e transformação dos dados", bucket)
	dsa_grava_log(traceback.format_exc(), bucket)
	spark.stop()
	raise Exception(traceback.format_exc())
...
try:
	...
	dsa_grava_log("Log - Ocorreu Alguma Falha ao Criar os Modelos de Machine Learning", bucket)
	dsa_grava_log(traceback.format_exc(), bucket)
	spark.stop()
	raise Exception(traceback.format_exc())

# Grava o log
dsa_grava_log("Log - Modelos Criados e Salvos no S3.", bucket)

# Grava o log
dsa_grava_log("Log - Processamento Finalizado com Sucesso.", bucket)
